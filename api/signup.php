...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (count($validation) === 0) {
        ...
        $query = $pdo->prepare('INSERT INTO users(username, email, password, fname, lname, dob, sex, license_accepted, verified) VALUES(?, ?, ?, ?, ?, ?, ?, 1, 1)');
        $query->execute([$username, $email, $hash, $fname, $lname, $dob, $sexDbval]);
    }
}
?>
...
<?= include_once __DIR__ . '/../includes/nav.php' ?>
    ...
    <form class="signup"method="POST">
        ...
        <div>
            ...
            <label class="register-contianer">Female<input type="radio" name="sex" value="F" /><span class="checkmark"></span>
            </label>
